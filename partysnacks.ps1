...
$Nuggets += OpAddOutputObj -name "BloodHound"                -project "BloodHoundAD"  -url "https://raw.githubusercontent.com/BloodHoundAD/BloodHound/master/Collectors/SharpHound.ps1"
